    ...
    return (
        <div className="relative isolate flex min-h-[70dvh] items-center justify-center overflow-hidden py-12">
            ...
            <div className="mx-auto max-w-2xl px-4 text-center">
                <div className="relative mx-auto grid h-28 w-28 grid-cols-4 overflow-hidden rounded-2xl border border-border/70 shadow-xl shadow-black/[0.07]" aria-hidden="true">
